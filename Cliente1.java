...
public class Cliente1 {
	...
	public static void main(String args[]) throws IOException {
		...
		try {
			...
			String nome = "";
			Cliente1.saiu = false; //um booleano para dizer se o cliente saiu ou n�o da conversa
			...
			while (true) {
				...
				if (cont == 0) {
					...
					else if (MensagensCliente1.mensagens.elementAt(posicao).charAt(1) == flagCliente.charAt(0)) { //quando o cliente escreve uma mensagem, a flag ser� y (apenas o que vai ser salvo localmente)
						podeApagar = true;
					}
					...
					posicaoUltimaMensagem = MensagensCliente1.mensagens.size(); //salva a posi��o da �ltima mensagem que recebeu
					Cliente1.saiu = true;
				}
					...
					flag = "8";
					for (int i = posicaoUltimaMensagem; i < MensagensCliente1.mensagens.size();i++) { //caso alguma mensagem foi enviada para o cliente enquanto ele tinha saido, neste momento elas ser�o impressas
				...
				else if (!Cliente1.saiu && cont != 0){ //caso o cliente n�o tenha saido e a mensagem n�o seja a primeira (nome), salvamos no vetor do cliente a mensagem
